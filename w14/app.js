...
class Order {
	constructor() {
		this.product = ['case','ram','motherboard','graphics-card','cpu','fan-kit','psu',];
	...
	randOrder() {
        ...
        if (productQuant0 === '-')  {
            ...
            output.textContent = 'Please place a minimum order greater or equal to "0" in each section above'
            ...
            if (output.textContent === 'Please place a minimum order greater or equal to "0" in each section above') {
                output.textContent = '';
            } else {
